...
class App(tk.Tk):
    ...
    def clean_data(self):
        ...
        ax1 = df.plot(kind="scatter", x="screen_size", y="normalized_used_price", color="r")
        df.plot(kind="scatter", x="rear_camera_mp", y="normalized_used_price", color="g", ax=ax1)
        df.plot(kind="scatter", x="front_camera_mp", y="normalized_used_price", color="b", ax=ax1)
        df.plot(kind="scatter", x="internal_memory", y="normalized_used_price", color="y", ax=ax1)
        df.plot(kind="scatter", x="ram", y="normalized_used_price", color="m", ax=ax1)
        df.plot(kind="scatter", x="battery", y="normalized_used_price", color="c", ax=ax1)
        df.plot(kind="scatter", x="weight", y="normalized_used_price", color="k", ax=ax1)
        df.plot(kind="scatter", x="days_used", y="normalized_used_price", color="orange", ax=ax1)
        df.plot(kind="scatter", x="normalized_new_price", y="normalized_used_price", color="brown", ax=ax1)
        plt.show()
